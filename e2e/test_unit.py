...
#     """Test reading unit properties"""
#     # Use a unit that should exist on all systems
#     with Unit(b"dbus.service") as unit:
#         assert unit.Unit.Id == b"dbus.service"
#         assert unit.Unit.LoadState in (b"loaded", b"not-found")
#
#         if unit.Unit.LoadState == b"loaded":
#             # Only test these if unit is loaded
#             assert isinstance(unit.Unit.ActiveState, bytes)
#             assert isinstance(unit.Unit.SubState, bytes)
